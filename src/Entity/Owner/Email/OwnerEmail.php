 ...
 */
class OwnerEmail extends BaseEmailLog implements BuildingEmailInterface
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Owner\Email\AutoEmail", inversedBy="emailLog")
     * @ORM\JoinColumn(name="automated_id", referencedColumnName="id", nullable=true)
     */
    protected $automatedEmail;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Owner\Email\EmailRecipient", mappedBy="emailLog", cascade={"all"}, orphanRemoval=true)
     * @Assert\NotBlank(message="validation.form.required")
     */
