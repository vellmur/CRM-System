...
/**
 * Class Apartment
 * @package App\Entity\Owner
 *
 * @ORM\Table(name="owner__apartment", uniqueConstraints={
...
class Apartment
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Owner\Owner", mappedBy="apartment", cascade={"all"})
     */
    private $residents;
