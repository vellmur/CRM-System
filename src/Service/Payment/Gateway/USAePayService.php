...
class USAePayService
{
     ...
     * reinsantiating the EpayService class
     *
     */
    function clearData()
    {
    ...
    public function customerPayment(Merchant $merchant, Invoice $invoice, $customerCard)
    {
        ...
        $this->usesandbox = $merchant->isSandbox();
        ...
        $this->zip = $billingAddress->getPostalCode();

        $this->billstate = $billingAddress->getRegion();
...
/**
    public function testSend() {
        $tran->key = '_H2h6Am81fdaqj14Rw8002BXksZLYM47';
        ...
        if ($tran->Process()){
            ...
            echo "<b>Card Declined</b> (" . $tran->error . ")<br>";
