...
final class Version20200515141844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE owner__notifies (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, notify_type INT NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_D4DC51699395C3F3 (owner_id), UNIQUE INDEX owner_emails_unique (owner_id, notify_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE owner__apartment (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, number VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_FD2BCDCB96901F54 (number), INDEX IDX_FD2BCDCB4D2A7E12 (building_id), UNIQUE INDEX aparment_unique (building_id, number), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE owner (id INT AUTO_INCREMENT NOT NULL, building_id INT DEFAULT NULL, apartment_id INT NOT NULL, firstname VARCHAR(25) NOT NULL, lastname VARCHAR(25) NOT NULL, email VARCHAR(50) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, notes TEXT DEFAULT NULL, created_at DATE NOT NULL, token VARCHAR(50) NOT NULL, is_activated TINYINT(1) NOT NULL, INDEX IDX_81398E094D2A7E12 (building_id), INDEX IDX_81398E09176DFE85 (apartment_id), UNIQUE INDEX owner_unique (building_id, email), UNIQUE INDEX owner_phone_unique (building_id, phone), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE email__recipient (id INT AUTO_INCREMENT NOT NULL, log_id INT NOT NULL, owner_id INT DEFAULT NULL, email_address VARCHAR(50) NOT NULL, is_sent TINYINT(1) NOT NULL, is_delivered TINYINT(1) NOT NULL, is_opened TINYINT(1) NOT NULL, is_clicked TINYINT(1) NOT NULL, is_bounced TINYINT(1) NOT NULL, INDEX IDX_892BA88BEA675D86 (log_id), INDEX IDX_892BA88B9395C3F3 (owner_id), UNIQUE INDEX owner_email_recipient (log_id, owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE owner__notifies ADD CONSTRAINT FK_D4DC51699395C3F3 FOREIGN KEY (owner_id) REFERENCES owner (id)');
        $this->addSql('ALTER TABLE owner__apartment ADD CONSTRAINT FK_FD2BCDCB4D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        $this->addSql('ALTER TABLE owner ADD CONSTRAINT FK_81398E094D2A7E12 FOREIGN KEY (building_id) REFERENCES building (id)');
        $this->addSql('ALTER TABLE owner ADD CONSTRAINT FK_81398E09176DFE85 FOREIGN KEY (apartment_id) REFERENCES owner__apartment (id)');
        $this->addSql('ALTER TABLE email__recipient ADD CONSTRAINT FK_892BA88BEA675D86 FOREIGN KEY (log_id) REFERENCES email__log (id)');
        $this->addSql('ALTER TABLE email__recipient ADD CONSTRAINT FK_892BA88B9395C3F3 FOREIGN KEY (owner_id) REFERENCES owner (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE owner DROP FOREIGN KEY FK_81398E09176DFE85');
        $this->addSql('ALTER TABLE owner__notifies DROP FOREIGN KEY FK_D4DC51699395C3F3');
        ...
        $this->addSql('ALTER TABLE owner__apartment DROP FOREIGN KEY FK_FD2BCDCB4D2A7E12');
        $this->addSql('ALTER TABLE owner DROP FOREIGN KEY FK_81398E094D2A7E12');
        ...
        $this->addSql('DROP TABLE owner__notifies');
        $this->addSql('DROP TABLE owner__apartment');
